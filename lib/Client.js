...
class Client extends EventEmitter {
    ...
    * @arg {String} [options.defaultImageFormat="png"] The default format to provide user avatars, guild icons, and group icons in. Can be "jpg", "png", "gif", or "webp"
    ...
    * @returns {Promise<Message>}
    */
    sendMessage(channelID, content, file) {
